  ...
  `;
    ...
    function timer(){
        TweenMax.to(line, 8,{
            ...
            onComplete: function(){if(!transition){ transitionNext() }},
          }).delay(0.5);
    }
    ...
    this.next = function(){if(!transition){ transitionNext() }};
    this.previous = function(){if(!transition){ transitionPrev() }};
  };
